...
<div class="animate-in" style="max-width:600px;">
    <div class="mb-4">
        ...
        <h2 class="outfit fw-bold mt-2 mb-0">Nuevo Ítem</h2>
    </div>
            ...
            <form method="POST" action="{{ route('service-items.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="code" class="form-control font-monospace @error('code') is-invalid @enderror"
                        value="{{ old('code') }}" placeholder="Ej: SRV-001">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="description" class="form-control @error('description') is-invalid @enderror"
                        value="{{ old('description') }}" required placeholder="Ej: Cambio de aceite 10W-40">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="number" name="default_price" class="form-control @error('default_price') is-invalid @enderror"
                            value="{{ old('default_price', 0) }}" min="0" step="1" required>
                ...
                <div class="d-flex gap-2 justify-content-end">
                    ...
                    <button type="submit" class="btn-primary-premium">
                        <i class="bi bi-check-lg"></i> Guardar Ítem
                    </button>
                </div>
            </form>
        </div>
